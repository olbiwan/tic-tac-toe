const TicTacToeTypeScript = require("../TicTacToeTypeScript.ts")
...
describe("invalid move", () => {
    ...
    test("typing letters", () => {
        ...
        const output = jest.fn().mockImplementationOnce(message => message)
         ...
         new TicTacToeTypeScript(mockPlays([{ line: 1, column: "x" },
                                            { line: 1, column: 1 },
                                            { line: 3, column: 3 },
                                            { line: 2, column: 1 },
                                            { line: 2, column: 2 },
    ...
    test("typing other characters", () => {
        ...
        new TicTacToeTypeScript(mockPlays([{ line: 1, column: "$" },
                                           { line: 1, column: 1 },
                                           { line: 3, column: 3 },
                                           { line: 2, column: 1 },
                                           { line: 2, column: 2 },
...
test("no winner", () => {
    ...
    new TicTacToeTypeScript(mockPlays([{ line: 1, column: 1 },
                                       { line: 2, column: 2 },
                                       { line: 2, column: 1 },
                                       { line: 3, column: 1 },
                                       { line: 1, column: 3 },
...
describe("win column", () => {
    ...
    test("Player O won!!!", () => {
        ...
        new TicTacToeTypeScript(mockPlays([{ line: 3, column: 3 },
                                           { line: 1, column: 1 },
                                           { line: 2, column: 2 },
                                           { line: 2, column: 1 },
                                           { line: 1, column: 3 },
...
describe("win diagonal", () => {
    ...
    test("Player O won!!!", () => {
        ...
        new TicTacToeTypeScript(mockPlays([{ line: 1, column: 2 },
                                           { line: 1, column: 1 },
                                           { line: 1, column: 3 },
                                           { line: 2, column: 2 },
                                           { line: 3, column: 2 },
...
describe("win line", () => {
    ...
    test("Player O won!!!", () => {
        ...
        new TicTacToeTypeScript(mockPlays([{ line: 2, column: 2 },
                                           { line: 1, column: 1 },
                                           { line: 3, column: 3 },
                                           { line: 1, column: 2 },
                                           { line: 3, column: 2 },
